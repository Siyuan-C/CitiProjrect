...
public interface LevelRepository extends JpaRepository<LevelBean,Long>{
    ...
    @Query(value = "SELECT * FROM level WHERE ShortName like %:enterprise_name%",nativeQuery = true)
    LevelBean findLevelByName1(@Param("enterprise_name")String enterprise_name);
}
