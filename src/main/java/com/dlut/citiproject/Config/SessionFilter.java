...
public class SessionFilter implements Filter {
    ...
    String[] includeUrls = new String[]{"/login","/","/register","/login_data","/search","/result","/search_data","/enterprise","/env_performance.html","/navbar.html","/footer.html"
            ,"/overall","/env_performance","/env_disclosure","/env_investment","/soc_safety","/soc_customer","/soc_public","/gov_risk","/gov_admin","/gov_manage","/navbar","/footer","/ent_upload","/my_account"};
